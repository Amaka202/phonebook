...
// fetch data from firestore using react firestore hook
        ...
        <div>
            ...
            <div className='bg-background-color min-h-minH mt-1 flex p-6 md:p-12 md:flex-row flex-col'>
                <div className='md:w-1/5 md:mr-6 mb-6'>
                    <button className='bg-primary-color w-full rounded p-3.5 text-sm text-white font-bold mb-2' type='submit' onClick={() => handleShowContactForm()}>
                    + Create contact
                    </button>
                    ...
                    <tr className=' text-placeholder-color font-bold'>
                        ...
                        {contacts && contacts.map(contact => {
                            return (
                                    ...
                                    <td className="px-4 py-2 w-1/4 rounded text-right whitespace-nowrap" >
                                        <div className={styles.editIcon}>
                                            <img src={editIcon} alt='edit icon' className='h-4 w-4 md:mr-6 mr-2'/>
